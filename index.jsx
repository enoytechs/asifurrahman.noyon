...
“description”: “Web Developer, Android App Developer, SEO Strategist, and Branding & Packaging Designer based in Dubai, UAE — working with clients worldwide.”,
...
“Android App Development”,“SEO Strategy”,“Local SEO”,
“Google Business Profile”,“Branding Design”,“Packaging Design”,
...
“areaServed”: [“Worldwide”,“UAE”,“Dubai”,“Saudi Arabia”,“United Kingdom”,“United States”],
...
<meta property="og:description" content="Web Developer, SEO Strategist & Brand Designer based in Dubai, UAE — working with clients worldwide. Book a free consultation." />
...
<meta name="description" content="Asifurrahman Noyon — Web Developer, SEO Strategist, and Brand Designer in Dubai, UAE. Specializing in web development, branding, packaging design, SEO, and Android apps for clients worldwide." />
<title>Asifurrahman Noyon | Web Developer · SEO Expert · Brand Designer — Dubai, UAE</title>
```
...
rafRef.current = requestAnimationFrame(animate);
document.querySelectorAll(“a,button,.card-lift,.port-card”).forEach(el => {
...
const msg = encodeURIComponent(“Hi Noyon! I found your portfolio and I’d like to discuss my project.”);
return (
<a
...
const links = [“About”,“Services”,“Portfolio”,“Pricing”,“Testimonials”,“Contact”];
...
{/* Logo */}
<a href=”#home” onClick={e=>{e.preventDefault();scrollTo(“home”)}} style={{display:“flex”,alignItems:“center”,gap:10,textDecoration:“none”,color:“inherit”}}>
<div style={{
width:36,height:36,background:“var(–black)”,borderRadius:10,
...
>
<span style={{color:“white”,fontFamily:“Syne”,fontWeight:800,fontSize:16}}>N</span>
</div>
<div>
<div style={{fontFamily:“Syne”,fontWeight:700,fontSize:15,lineHeight:1.1}}>Asifurrahman</div>
<div style={{fontSize:11,color:“var(–gray-400)”,lineHeight:1,fontFamily:“DM Sans”}}>Noyon · Worldwide</div>
</div>
</a>
...
```
  ...
  <div className={`mobile-menu-panel ${menuOpen?"open":""}`}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:40}}>
      ...
      <button onClick={()=>setMenuOpen(false)} style={{background:"rgba(255,255,255,0.1)",border:"none",borderRadius:8,width:36,height:36,cursor:"pointer",color:"white",fontSize:18}}>✕</button>
    </div>
...
// Hero Section
function Hero() {
const typed = useTyping([“Brand.”, “Website.”, “App.”, “SEO.”, “Brand.”], 100, 55, 1800);
...
return (
<section id=“home” className=“hero-mesh” style={{minHeight:“100vh”,display:“flex”,alignItems:“center”,paddingTop:80,position:“relative”,overflow:“hidden”}}>
{/* Decorative blobs */}
<div style={{position:“absolute”,top:80,right:-40,width:480,height:480,borderRadius:“50%”,background:“radial-gradient(circle,rgba(16,185,129,0.08),transparent 70%)”,pointerEvents:“none”}}/>
<div style={{position:“absolute”,bottom:0,left:-60,width:360,height:360,borderRadius:“50%”,background:“radial-gradient(circle,rgba(5,150,105,0.05),transparent 70%)”,pointerEvents:“none”}}/>
{/* Floating dots */}
<div className=“float-1” style={{position:“absolute”,top:“35%”,left:“12%”,width:8,height:8,borderRadius:“50%”,background:“var(–em)”,opacity:0.4}}/>
<div className=“float-2” style={{position:“absolute”,top:“20%”,right:“18%”,width:12,height:12,borderRadius:“50%”,border:“2px solid var(–em)”,opacity:0.3}}/>
<div className=“float-3” style={{position:“absolute”,bottom:“25%”,left:“30%”,width:6,height:6,borderRadius:“50%”,background:“var(–em-light)”,opacity:0.5}}/>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"center"}} className="hero-grid">
      ...
      <div style={{display:"flex",flexDirection:"column",gap:28}}>
        ...
        <p ref={r3} className="reveal d2" style={{fontSize:17,color:"var(--gray-600)",fontFamily:"DM Sans",fontWeight:300,lineHeight:1.7,maxWidth:480}}>
          I'm <strong style={{color:"var(--black)",fontWeight:600}}>Asifurrahman Noyon</strong> — Web Developer, SEO Strategist &amp; Brand Designer helping businesses worldwide build powerful brands, beautiful websites, and dominant search presence.
        </p>
...
const skills = [“Web Development”,“Branding”,“Packaging Design”,“Local SEO”,“Google Business Profile”,“Android Apps”,“UI/UX Design”,“E-Commerce”,“Label Design”,“React.js”,“WordPress”,“Print Production”];
return (
<div style={{background:“var(–black)”,padding:“18px 0”,overflow:“hidden”,borderTop:“1px solid #1f2937”,borderBottom:“1px solid #1f2937”}}>
<div className="marquee-track">
{[…skills,…skills].map((s,i)=>(
<div key={i} style={{display:“flex”,alignItems:“center”,gap:16,paddingRight:48,flexShrink:0}}>
<span style={{width:6,height:6,borderRadius:“50%”,background:“var(–em)”,display:“inline-block”}}/>
<span style={{fontFamily:“Syne”,fontWeight:600,fontSize:14,color:“white”,whiteSpace:“nowrap”}}>{s}</span>
</div>
))}
</div>
</div>
...
return (
<section id=“about” style={{padding:“100px 0”,background:“var(–black)”,color:“white”,position:“relative”,overflow:“hidden”}}>
<div style={{position:“absolute”,top:0,right:0,width:300,height:300,borderRadius:“50%”,background:“radial-gradient(circle,rgba(16,185,129,0.08),transparent 70%)”}}/>
<div style={{position:“absolute”,bottom:0,left:0,width:200,height:200,borderRadius:“50%”,background:“radial-gradient(circle,rgba(16,185,129,0.05),transparent 70%)”}}/>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"start"}} className="about-grid">
      ...
      <div ref={leftRef} className="reveal-left">
        <div ref={codeRef} style={{background:"#0f1117",borderRadius:24,padding:32,border:"1px solid #1f2937",position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:24}}>
            ...
            <span style={{marginLeft:"auto",fontSize:10,color:"var(--em)",fontFamily:"DM Sans",background:"rgba(16,185,129,0.1)",padding:"2px 8px",borderRadius:100}}>● LIVE</span>
          </div>
      ...
      <div ref={rightRef} className="reveal-right" style={{display:"flex",flexDirection:"column",gap:24}}>
        ...
        <p style={{color:"#9ca3af",fontFamily:"DM Sans",fontWeight:300,lineHeight:1.8,fontSize:15}}>
          I'm <span style={{color:"white",fontWeight:500}}>Asifurrahman Noyon</span> — a multi-disciplinary digital specialist based in Dubai, UAE, working with clients globally. With expertise across web development, Android apps, SEO strategy, and branding &amp; packaging design, I give businesses what agencies can't: a single expert who masters your entire digital footprint.
        </p>

        <p style={{color:"#9ca3af",fontFamily:"DM Sans",fontWeight:300,lineHeight:1.8,fontSize:15}}>
          I work with startups and growing businesses across the UAE, GCC, and worldwide — helping them rank on Google, build stunning brands, and convert visitors into loyal customers. Remote-friendly, results-driven.
        </p>
...
<span style={{fontSize:13,fontFamily:“DM Sans”,color:”#d1d5db”}}>{label}</span>
<span style={{fontSize:12,fontFamily:“Syne”,fontWeight:700,color:“var(–em-light)”}}>{pct}%</span>
</div>
<div style={{height:5,background:”#1f2937”,borderRadius:100,overflow:“hidden”}}>
<div className={`skill-bar-fill ${animate?"animate":""}`} style={{”–target-width”:`${pct}%`}}/>
</div>
</div>
);
}
...
items: [“Product packaging design”,“Label & sticker design”,“Print-ready production files”,“Manufacturer guidance”],
dark: false,
badge: null,
},
{
...
items: [“Business & corporate websites”,“Landing pages & lead funnels”,“E-commerce stores”,“Android mobile applications”],
dark: true,
badge: “Most Popular”,
},
{
...
items: [“Google Business Profile setup”,“Local SEO & keyword ranking”,“Competitive strategy & audits”,“Monthly optimization reports”],
dark: false,
badge: null,
},
];
...
return (
<section id=“services” style={{padding:“100px 0”,background:“white”,position:“relative”}} className=“stripe-bg”>
<div style={{maxWidth:1280,margin:“0 auto”,padding:“0 24px”}}>
<div ref={h} className=“reveal” style={{textAlign:“center”,marginBottom:64}}>
...
<p style={{color:“var(–gray-600)”,fontFamily:“DM Sans”,fontWeight:300,maxWidth:520,margin:“0 auto”,lineHeight:1.7}}>
End-to-end solutions for businesses worldwide — launch, compete, and dominate your market.
</p>
</div>
...
borderRadius: 24,
padding: 32,
boxShadow: dark ? “0 24px 64px rgba(0,0,0,0.2)” : “0 2px 16px rgba(0,0,0,0.04)”,
position: “relative”,
overflow: “hidden”,
}}
>
{dark && <div style={{position:“absolute”,top:0,right:0,width:120,height:120,borderRadius:“50%”,background:“rgba(16,185,129,0.1)”,filter:“blur(40px)”}}/>}
{badge && (
<div style={{position:“absolute”,top:20,right:20,background:“rgba(16,185,129,0.2)”,color:“var(–em-light)”,fontSize:11,fontFamily:“DM Sans”,padding:“4px 10px”,borderRadius:100,fontWeight:500}}>{badge}</div>
)}
...
const projects = [
{title:“FreshBox – Organic Food Brand”,cat:“Branding”,desc:“Complete brand identity & packaging for UAE organic food startup. Launch-ready in 3 weeks.”,gradient:“from-emerald-400 to-teal-600”,color:”#10b981”},
{title:“TechPro – IT Services Dubai”,cat:“Web Dev”,desc:“Corporate website with lead generation. 3x enquiry increase in first month.”,gradient:“from-slate-700 to-black”,color:”#6b7280”},
{title:“SpiceHub – Restaurant Sharjah”,cat:“SEO”,desc:“Google Business Profile optimization. Ranked #1 for ‘Indian restaurant Sharjah’ in 6 weeks.”,gradient:“from-orange-400 to-rose-600”,color:”#f97316”},
{title:“Glowify – Beauty Booking App”,cat:“Android App”,desc:“Android booking app for UAE salon chain. 500+ downloads in first month.”,gradient:“from-violet-500 to-purple-800”,color:”#8b5cf6”},
{title:“CleanPro – Cleaning Services UAE”,cat:“Web Dev”,desc:“Brand + website + local SEO. From zero to 50+ monthly leads in 60 days.”,gradient:“from-sky-400 to-blue-700”,color:”#0ea5e9”},
{title:“GoldCraft – Luxury Jewelry UAE”,cat:“Branding”,desc:“Premium packaging & brand identity for high-end jewelry retailer in Dubai Gold Souk.”,gradient:“from-amber-400 to-orange-600”,color:”#f59e0b”},
];
...
<h2 style={{fontFamily:“Syne”,fontWeight:800,fontSize:“clamp(32px,4.5vw,52px)”,letterSpacing:”-0.02em”,lineHeight:1.1}}>
Real Projects,<br/><span className="grad-text">Real Results</span>
</h2>
</div>
<p style={{color:“var(–gray-600)”,fontFamily:“DM Sans”,fontWeight:300,maxWidth:280,fontSize:14,lineHeight:1.7}}>Brands and businesses I’ve helped launch and grow — UAE & worldwide.</p>
</div>
...
const ref = useReveal();
const catColors = {“Branding”:“var(–em-bg)”,“Web Dev”:”#f0f9ff”,“SEO”:”#fefce8”,“Android App”:”#faf5ff”};
const catText = {“Branding”:“var(–em-dark)”,“Web Dev”:”#0369a1”,“SEO”:”#92400e”,“Android App”:”#6d28d9”};
return (
<div ref={ref} className={`reveal port-card card-lift`} style={{transitionDelay:`${delay}s`,background:“white”,borderRadius:20,overflow:“hidden”,border:“1px solid var(–gray-100)”}}>
{/* Thumbnail */}
<div style={{height:180,background:`linear-gradient(135deg,${color}22,${color}66)`,position:“relative”,overflow:“hidden”,display:“flex”,alignItems:“center”,justifyContent:“center”}}>
<div style={{textAlign:“center”}}>
<div style={{fontFamily:“Syne”,fontWeight:800,fontSize:28,color:color}}>{title.split(”–”)[0].trim()}</div>
<div style={{fontSize:12,color:`${color}88`,fontFamily:“DM Sans”,marginTop:4}}>{cat}</div>
</div>
<div className=“port-overlay” style={{position:“absolute”,inset:0,background:“rgba(0,0,0,0.6)”,display:“flex”,alignItems:“center”,justifyContent:“center”}}>
<button onClick={()=>document.getElementById(“contact”)?.scrollIntoView({behavior:“smooth”})} style={{background:“var(–em)”,color:“white”,border:“none”,padding:“10px 20px”,borderRadius:100,fontFamily:“DM Sans”,fontWeight:500,fontSize:13,cursor:“pointer”}}>View Details</button>
</div>
</div>
...
const hRef = useReveal();
const steps = [
{n:“01”,title:“Consultation”,desc:“Free 30-min discovery call to understand your business, goals, and challenges.”,icon:“💬”},
{n:“02”,title:“Research”,desc:“Deep competitor analysis, keyword research, and market study for your industry.”,icon:“🔍”},
{n:“03”,title:“Strategy”,desc:“Custom growth plan with clear milestones, timelines, and measurable KPIs.”,icon:“🎯”},
{n:“04”,title:“Design & Build”,desc:“Crafting your brand assets, website, or app with feedback loops built in.”,icon:“⚡”},
{n:“05”,title:“Launch”,desc:“Smooth deployment with testing, QA, and go-live support for a flawless launch.”,icon:“🚀”},
{n:“06”,title:“Growth & Optimize”,desc:“Ongoing monitoring, reporting, and refinement to continuously improve results.”,icon:“📈”},
];

return (
<section id=“process” style={{padding:“100px 0”,background:“var(–black)”,color:“white”,position:“relative”,overflow:“hidden”}}>
{/* Grid lines */}
<div style={{position:“absolute”,inset:0,backgroundImage:“radial-gradient(rgba(16,185,129,0.05) 1px,transparent 1px)”,backgroundSize:“40px 40px”,pointerEvents:“none”}}/>
...
style={{
background: isAccent ? “linear-gradient(135deg,var(–em-dark),var(–em))” : “#111827”,
...
onMouseEnter={e=>{if(!isAccent)e.currentTarget.style.borderColor=“var(–em)”;e.currentTarget.style.transform=“translateY(-4px)”}}
onMouseLeave={e=>{if(!isAccent)e.currentTarget.style.borderColor=”#1f2937”;e.currentTarget.style.transform=””}}
>
<div style={{display:“flex”,alignItems:“center”,gap:14,marginBottom:14}}>
<div style={{
width:46, height:46,
background: isAccent ? “rgba(255,255,255,0.2)” : “rgba(16,185,129,0.1)”,
borderRadius: 12,
display:“flex”,alignItems:“center”,justifyContent:“center”,
...
<h3 style={{fontFamily:“Syne”,fontWeight:700,fontSize:17,color:“white”,marginBottom:8}}>{title}</h3>
<p style={{color: isAccent ? “rgba(255,255,255,0.7)” : “#6b7280”,fontFamily:“DM Sans”,fontWeight:300,fontSize:13,lineHeight:1.7}}>{desc}</p>
</div>
);
}
...
return (
<section id=“pricing” style={{padding:“100px 0”,background:“var(–black)”,position:“relative”,overflow:“hidden”}}>
{/* Grid dot bg */}
<div style={{position:“absolute”,inset:0,backgroundImage:“radial-gradient(rgba(16,185,129,0.06) 1px,transparent 1px)”,backgroundSize:“36px 36px”,pointerEvents:“none”}}/>
{/* Glow blobs */}
<div style={{position:“absolute”,top:”-80px”,left:“50%”,transform:“translateX(-50%)”,width:600,height:300,borderRadius:“50%”,background:“radial-gradient(ellipse,rgba(16,185,129,0.08),transparent 70%)”,pointerEvents:“none”}}/>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",padding:"0 24px",position:"relative"}}>
    ...
    <div ref={hRef} className="reveal" style={{textAlign:"center",marginBottom:56}}>
      ...
      <p style={{color:"#6b7280",fontFamily:"DM Sans",fontWeight:300,maxWidth:520,margin:"0 auto",lineHeight:1.75,fontSize:15}}>
        No hidden fees. No agency markup. Just real value for businesses everywhere — starting low so you can grow without risk.
      </p>
    ...
    <div className="reveal" style={{textAlign:"center",marginTop:52}}>
      ...
      <div style={{marginTop:20}}>
        ...
        >Need a Custom Quote? Let's Talk →</button>
      </div>
    </div>
  </div>
...
position:“relative”,
overflow:“hidden”,
transition:“border-color 0.3s, transform 0.35s cubic-bezier(0.16,1,0.3,1), box-shadow 0.35s ease”,
transform: hovered ? “translateY(-8px)” : “none”,
boxShadow: highlight
? hovered ? “0 32px 80px rgba(16,185,129,0.3)” : “0 16px 48px rgba(16,185,129,0.15)”
: hovered ? “0 24px 64px rgba(0,0,0,0.5)” : “none”,
height:“100%”,
display:“flex”,flexDirection:“column”,
}}>
{/* Glow top line */}
{highlight && <div style={{position:“absolute”,top:0,left:0,right:0,height:2,background:“linear-gradient(90deg,transparent,var(–em),transparent)”}}/>}
...
const rightRef = useReveal();
const reasons = [
{title:“Real Production Knowledge”,desc:“I don’t just design concepts — I understand print specs, code performance, and SEO algorithms from hands-on experience.”,icon:“💡”},
{title:“Tech + Design Combo”,desc:“Most designers can’t code. Most developers can’t design. I do both, saving you time, money, and communication overhead.”,icon:“⚡”},
{title:“International + UAE Experience”,desc:“Based in Dubai, UAE — I work with clients globally. I understand both international markets and local GCC business culture, giving your brand a competitive edge wherever you are.”,icon:“🌍”},
{title:“Result-Oriented Strategy”,desc:“Every decision ties to measurable outcomes — more leads, better rankings, higher conversions. No vanity metrics.”,icon:“📈”},
];
...
```
      <div ref={leftRef} className="reveal-left" style={{display:"flex",flexDirection:"column",gap:24}}>
        ...
        <p style={{color:"var(--gray-600)",fontFamily:"DM Sans",fontWeight:300,lineHeight:1.7,fontSize:15,maxWidth:480}}>
          When you work with me, you get a single strategic partner who understands design, code, and marketing — and how they work together to grow your business.
        </p>
...
const hRef = useReveal();
const testimonials = [
{name:“Ahmed Mohammed”,role:“CEO, FreshBite Foods – Sharjah”,initials:“AM”,color:”#10b981”,
...
{name:“Sara Khalid”,role:“Founder, PureClean Services – Dubai”,initials:“SK”,color:”#0ea5e9”,dark:true,
...
{name:“James Al-Rashidi”,role:“Director, GoldCraft Jewels – Dubai”,initials:“JA”,color:”#f59e0b”,
...
return (
<section id=“testimonials” style={{padding:“100px 0”,background:”#f9fafb”}}>
<div style={{maxWidth:1280,margin:“0 auto”,padding:“0 24px”}}>
<div ref={hRef} className=“reveal” style={{textAlign:“center”,marginBottom:64}}>
...
borderRadius: 20,
padding: 28,
boxShadow: dark ? “0 24px 64px rgba(0,0,0,0.15)” : “0 2px 16px rgba(0,0,0,0.04)”,
transitionDelay: `${delay}s`,
}}
>
...
<p style={{color: dark ? “#9ca3af” : “var(–gray-600)”,fontFamily:“DM Sans”,fontWeight:300,fontSize:14,lineHeight:1.8,marginBottom:20,fontStyle:“italic”}}>
“{text}”
</p>
<div style={{display:“flex”,alignItems:“center”,gap:12}}>
<div style={{width:40,height:40,borderRadius:“50%”,background:`linear-gradient(135deg,${color}88,${color})`,display:“flex”,alignItems:“center”,justifyContent:“center”,fontFamily:“Syne”,fontWeight:700,fontSize:14,color:“white”,flexShrink:0}}>{initials}</div>
<div>
<div style={{fontFamily:“Syne”,fontWeight:700,fontSize:14,color:dark?“white”:“var(–black)”}}>{name}</div>
<div style={{fontSize:12,color:“var(–gray-400)”,fontFamily:“DM Sans”}}>{role}</div>
</div>
</div>
</div>
);
...
const phone = “971545261933”;
const waMsg = encodeURIComponent(“Hi Noyon! I found your portfolio and I’d like to discuss my project.”);

return (
<section id=“contact” style={{padding:“100px 0”,background:“white”,position:“relative”,overflow:“hidden”}}>
<div style={{position:“absolute”,top:0,right:0,width:400,height:400,borderRadius:“50%”,background:“radial-gradient(circle,rgba(16,185,129,0.05),transparent 70%)”,pointerEvents:“none”}}/>
<div style={{position:“absolute”,bottom:0,left:0,width:300,height:300,borderRadius:“50%”,background:“radial-gradient(circle,rgba(16,185,129,0.04),transparent 70%)”,pointerEvents:“none”}}/>
  ...
  <div style={{maxWidth:1280,margin:"0 auto",padding:"0 24px",position:"relative"}}>
    <div ref={hRef} className="reveal" style={{textAlign:"center",marginBottom:64}}>
      ...
      <p style={{color:"var(--gray-600)",fontFamily:"DM Sans",fontWeight:300,maxWidth:480,margin:"0 auto",lineHeight:1.7}}>
        Book a free 30-minute consultation. No pressure, no obligation — just a real conversation about your goals.
      </p>
    </div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:48,alignItems:"start"}} className="contact-grid">
      ...
      <div ref={rightRef} className="reveal-right" style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        {[
          ...
          {icon:<svg width="18" height="18" fill="none" stroke="var(--em-light)" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>, label:"Location", value:"Dubai, UAE — Available Worldwide"},
          {icon:<svg width="18" height="18" fill="none" stroke="var(--em-light)" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>, label:"Response Time", value:"Within 24 hours · Mon–Sat"},
        ...
        <div style={{padding:16,border:"1px solid var(--gray-100)",borderRadius:14}}>
          ...
          <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
            {["🌍 Worldwide","🇦🇪 UAE","🇸🇦 Saudi Arabia","🇬🇧 UK","🇺🇸 USA","+ More"].map(city=>(
...
function Footer() {
const links = [“About”,“Services”,“Portfolio”,“Pricing”,“Testimonials”,“Contact”];
const services = [“Packaging Design”,“Web Development”,“Android Apps”,“SEO Strategy”,“Google Business”];
...
return (
<footer style={{background:“var(–black)”,color:“white”,padding:“64px 0 32px”}}>
<div style={{maxWidth:1280,margin:“0 auto”,padding:“0 24px”}}>
    ...
    {/* Brand */}
      <div>
        ...
        <p style={{color:"#6b7280",fontSize:13,fontFamily:"DM Sans",fontWeight:300,lineHeight:1.8,maxWidth:300,marginBottom:20}}>
          Helping businesses worldwide build powerful digital presence through branding, web development, SEO, and app development. Based in Dubai, UAE — working globally.
        </p>
        {/* Socials */}
...
useEffect(() => {
const sections = [“home”,“about”,“services”,“portfolio”,“pricing”,“process”,“testimonials”,“contact”];
...
style={{
position:“fixed”,bottom:100,right:28,width:44,height:44,
background:“var(–black)”,color:“white”,border:“none”,borderRadius:12,
cursor:“pointer”,zIndex:999,display:“flex”,alignItems:“center”,justifyContent:“center”,
boxShadow:“0 8px 24px rgba(0,0,0,0.2)”,
transition:“transform 0.3s,background 0.2s”,
animation:“slide-in-up 0.3s ease”,
}}
onMouseEnter={e=>{e.currentTarget.style.background=“var(–em)”;e.currentTarget.style.transform=“translateY(-2px)”}}
onMouseLeave={e=>{e.currentTarget.style.background=“var(–black)”;e.currentTarget.style.transform=””}}
